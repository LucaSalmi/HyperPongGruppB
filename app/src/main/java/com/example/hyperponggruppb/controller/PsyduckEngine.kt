    ...
    fun brickCollision(
        ...
        for (brick in brickRow) {
            ...
            if (ball.ballRect.intersect(brickRect)) {
                ...
                SoundEffectManager.playBrickHitSound(context, RandomNumberGenerator.rNG(0, 3))
            }
        }
        ...
        } else if (ball.brickCollision && gameManager.isStoryMode && infoBrick.hasPowerUp > 0) {

            storyModePowerUpSpawn(powerUpArray, infoBrick.hasPowerUp)
        }
